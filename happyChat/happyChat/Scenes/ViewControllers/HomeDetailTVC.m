...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        if (_headImgDic[_statusModel.userId]) {
            [cell.userImg sd_setImageWithURL:[NSURL URLWithString:_headImgDic[_statusModel.userId]]];
        }else {
        ...
        cell.myBlockPic = ^() {
            ...
            change.picture = _statusModel.picArray.lastObject;
        ...
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        if (_headImgDic[_comment.comName]) {
            [cell.imgView sd_setImageWithURL:[NSURL URLWithString:_headImgDic[_comment.comName]]];
        }else {
